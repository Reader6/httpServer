...
public:
    ...
    bool Select(MYSQL *conn, char *TableName, char *ColumnName,
...
private:
    ...
    void ToJson(char *ColumnName, vector<vector<string>> ColumnValue);
public:
    ...
    //get那里数据怎么解析
    bool Update(MYSQL *conn, char *TableName, char *Constraint, char *ConstraintValue,
                char *updateValue);
